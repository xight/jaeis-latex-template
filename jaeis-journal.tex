...
\title{日本情報科教育学会誌}
\etitle{Japan Association for Education of Information Studies}
\subtitle{原稿執筆要領}
\esubtitle{Writing Guidelines}
...
\keyword{
	情報科教育，高校教育，教育効果，キーワード4，キーワード5
}

\author{情報 太郎\hspace{3cm}情報 花子\hspace{3cm}情報 次郎}
\affiliation{情報大学教育学部\hspace{2cm}情報大学工学部\hspace{2cm}情報大学大学院大学}

\eauthor{Taro Joho\hspace{1cm}Hanako Joho\hspace{1cm}Jiro Joho}
\eaffiliation{Joho University\hspace{1cm}Joho University\hspace{1cm}Joho University Graduate School}
...
論文投稿は，EasyChairをご利用ください．EasyChair による論文投稿の手順は，学会のＷｅｂページから参照可能です．
